    ...
    <footer className={styles.footer__distributed}>
        ...
        <IconContext.Provider value={{ color: "white", size: "1.5em" }}>
          <div>
            <Link
              ...
              href="https://www.google.com/maps/place/Sirun+Patisserie/@-34.6297476,-58.4646269,15.28z/data=!4m5!3m4!1s0x0:0xf912710b6a7e163d!8m2!3d-34.6304833!4d-58.4632808"
              target={"_blank"}
            >
              <FaMapMarkerAlt />
          ...
          <div>
            <Link
              className={styles.footer__icons}
              href="https://api.whatsapp.com/send/?phone=5491146122637&text&type=phone_number&app_absent=0"
              target={"_blank"}
            >
              <BsFillTelephoneFill />
      ...
      <div className={styles.footer__right}>
        ...
        <p className={styles.footer__about}>
          Hi, I&apos;m Nati! I&apos;m the founder of Sirun Pâtisserie. I make
          artisan and professional pastry for all kinds of events, snacks and
          other special occasions. We would be extremely happy to make your next
          event a very special occasion! Do not hesitate to contact us!
        </p>

        <div className={styles.footer__rrssicons}>
          <IconContext.Provider value={{ color: "white", size: "1.5em" }}>
            <Link
              href="https://www.facebook.com/SirunPatisserie/"
              target={"_blank"}
            >
              <BsFacebook />
            </Link>
            ...
            <Link
              href="https://www.tiktok.com/@sirun_patisserie"
              target={"_blank"}
            >
              <FaTiktok />
            </Link>
            <Link
              href="https://www.instagram.com/sirun_patisserie/"
              target={"_blank"}
            >
              <BsInstagram />
            </Link>
