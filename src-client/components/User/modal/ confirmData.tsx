            ...
            >
                <div className={styles.modal__container}>
                    <div className={styles.modal__btn_right_container}>
                        <button className={styles.modal__close_modal_btn} onClick={() => isOpenModal()}>x</button>
                    </div>
                    ...
                    <div className={styles.modal__client_container}>
                        ...
                        <p className={styles.modal__client_name}>
                            <span className={styles.client_info_span}>Name: </span>{name.toLowerCase()}
                        </p>
                        <p>
                            <span className={styles.client_info_span}>E-mail: </span>{email}
                        </p>
                        <div className={styles.modal__client_phone}>
                            <p className={styles.modal__client_name} >
                                <span className={styles.client_info_span}>  Name Address : </span>
                                {address.name_address ? address.name_address : addressRef.current.name_address}</p>
                            <p>
                                <span className={styles.client_info_span}>  Phone number: </span>
                                {address.number ? address.number : addressRef.current.phone.number}
                            </p>
                            <p>
                                <span className={styles.client_info_span}>  Area Code: </span>
                                {address.area_code ? address.area_code : addressRef.current.phone.area_code}
                            </p>
                        </div>
                        <div className={styles.modal__client_address_container}>
                            <p className={styles.modal__client_street}>
                                <span className={styles.client_info_span}>Street Name: </span>{address.street_name ? address.street_name.toLowerCase() : addressRef.current.street_name.toLowerCase()}
                            </p>
                            <p className={styles.modal__client_street}>
                                <span className={styles.client_info_span}>Street Number: </span>{address.street_number ? address.street_number : addressRef.current.street_number}
                            </p>
                            <p>
                                <span className={styles.client_info_span}>Zip code: </span>
                                {address.zip_code ? address.zip_code : addressRef.current.zip_code}
                            </p>
